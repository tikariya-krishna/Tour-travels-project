...
import sideImage from '../pages/image/sunset.jpg'

function Tour_packeg1(){
    return(
        <>
            {/* <div className="col">
                <div className="row-4">
                ...
                {/* <div className='main-packege row'>       
                    ...
                    <div className='uper-txt'><h1><a href='#' className='text-decoration-none text-white'>SUNSET</a></h1></div>


                    <div className='packege-detail  col-7'>
                        <div className='detail-top text-center'><h2 className='font-weight-bolder text-white'>Sunset with Diu Sea</h2></div>
                        <hr className='text-white'/>
                        <div className='detail-foot text-white'>The hillock and the surrounding areas have been beautifully landscaped and illuminated. Chakratirth Beach is centrally located and contiguous to the Diu Town. Visitors also go to the Khodidhar beach which is another sunset viewpoint.</div>
                    </div>
                ...
                <div className="row no-gutters">
                    ...
                    <div className="col-12 col-md-7">
                        <div className="mid-searchpack">
                            <h5>AWESOME GOA WITH 04 STAR ACCOMMODATION-LONG WEEKEND SPECIAL EX MUMBAI</h5>
